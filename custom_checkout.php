		...
		<div class="mp-col-md-12">
			<div class="frame-tarjetas">
				...
				<div id="mercadopago-form">
					...
					<!--
							Mod Workana: Ocultar número de cuotas en pago con tarjeta { Noviembre 2019 }
							Autor:  Claudia Hernandez
									clauah.23@gmail.com

							Definir propiedad visibility:hidden al elemento div
					-->
					<div class="mp-col-md-12" style="visibility:hidden; height:0">
						<div class="frame-tarjetas">
							<!--p class="mp-subtitle-custom-checkout"><?= __('In how many installments do you want to pay?', 'woocommerce-mercadopago') ?></p-->

							<div class="mp-row-checkout mp-10">
								<div class="mp-col-md-12 mp-pr-15">
									<div class="mp-issuer">
										<!--label for="issuer" class="mp-label-form"><?= esc_html__('Issuer', 'woocommerce-mercadopago'); ?> </label-->
										<select class="mp-form-control mp-pointer mp-5" style="height:0 !important" id="issuer" data-checkout="issuer" name="mercadopago_custom[issuer]"></select>
									</div>
								</div>
								...
								<div id="installments-div" class="mp-col-md-8">
									...
									<?php endif; ?>
									<select class="mp-form-control mp-pointer mp-5" style="height:0 !important" id="installments" data-checkout="installments" name="mercadopago_custom[installments]"></select>
		...
		MPv1.setInstallmentInfo = function(status, response) {
			...
			if (response.length > 0) {
				...
				/* ------------------------------------------------------------------------------
					...
					comentar iteración(for) en número de cuotas y asignar una couta por defecto
					al elemento select "installments"
				------------------------------------------------------------------------------ */
				...
				*/
				...
				var html_option = "<option value='" + payerCosts[0].installments + "' " + dataInput + ">" +
					(payerCosts[0].recommended_message || payerCosts[0].installments) +
					"</option>";
				// Fin Mod Workana: Ocultar número de cuotas en pago con tarjeta { Noviembre 2019 }
